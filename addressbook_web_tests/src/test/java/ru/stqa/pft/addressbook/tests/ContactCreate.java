...
public class ContactCreate extends TestBase {
  ...
  public void testContactCreate() throws Exception {
    ...
    app.getContactHelper().fillContactFormGeneral(new ContactDataGeneral("firstName", "middleName", "LastName", "nickName", "title", "company", "address", "test@test.test", "18", "October", "1000", "testName"));
